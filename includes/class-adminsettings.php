...
class AdminSettings {
	...
	public function __construct() {
		register_setting( 'ac_geo_redirect_settings_page', 'agr_options', [ $this, 'validate_options' ] );
		add_action( 'admin_init', [ $this, 'initialize_setting_section_options' ] );
	 ...
	 * Define settings.
	 */
	public function initialize_setting_section_options() {
	...
	public function validate_options( array $input ) {
		...
		return apply_filters( 'ac_geo_redirect_validate_options', $output );
	}
